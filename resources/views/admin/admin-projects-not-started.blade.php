...
@section('content')
    {{-- project modal data --}}
    @include('admin.include.project-not-started-modals.admin-show-project-not-started-modal')
    @include('admin.include.project-not-started-modals.admin-delete-project-not-started-modal')
    <div id="main">
