...
@section('content')
    {{-- project modal data --}}
    @include('admin.include.project-in-progress-modals.admin-show-project-in-progress-modal')
    @include('admin.include.project-in-progress-modals.admin-delete-project-in-progress-modal')
    <div id="main">
