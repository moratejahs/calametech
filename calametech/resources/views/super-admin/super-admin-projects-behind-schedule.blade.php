...
@section('title', 'Behind Schedule Projects')
@section('links')
...
@section('content')
    {{-- project modal data --}}
    @include('super-admin.include.project-behind-schedule-modals.super-admin-show-project-behind-schedule-modal')
    @include('super-admin.include.project-behind-schedule-modals.super-admin-delete-project-behind-schedule-modal')
    <div id="main">
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <h5>Behind Schedule Project Records</h5>
                    </div>
                    <div class="card-body">
                        <table class="table table-hover" id="userProjectTable">
                            ...
                            <tbody>
                                ...
                                @foreach ($behindScheduleProjectData as $project)
                                    <tr>
                                        <td>
                                            {{ $loop->iteration }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#viewProjectBehindScheduleModal"
                                                ...
                                                @if ($project->created_by == auth()->user()->id)
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                        data-bs-target     ="#deleteProjectBehindScheduleModal"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const viewRecordUser = document.querySelectorAll(
                'button[data-bs-target="#viewProjectBehindScheduleModal"]');
            const removeRecord = document.querySelectorAll(
                'button[data-bs-target="#deleteProjectBehindScheduleModal"]');
