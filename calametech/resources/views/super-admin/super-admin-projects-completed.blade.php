...
@section('content')
    @include('super-admin.include.project-completed-modals.super-admin-show-project-completed-modal')
    @include('super-admin.include.project-completed-modals.super-admin-delete-project-completed-modal')
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <h5>Completed Project Records</h5>
                    </div>
                    <div class="card-body">
                        <table class="table table-hover" id="userProjectTable">
                            ...
                            <tbody>
                                @foreach ($completedProjectData as $project)
                                    <tr>
                                        <td>
                                            {{ $loop->iteration }}
                                        </td>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#viewProjectCompletedModal"
                                                    ...
                                                    data-bs-completedDate    = "{{ $project->updated_at->format('Y-m-d') }}"
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const viewRecordUser = document.querySelectorAll('button[data-bs-target="#viewProjectCompletedModal"]');
            const removeRecord = document.querySelectorAll('button[data-bs-target="#deleteProjectModal"]');
            ...
            viewRecordUser.forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    const completedDate = this.getAttribute('data-bs-completedDate');
                    ...
                    document.getElementById('completedDate').innerText = completedDate;
