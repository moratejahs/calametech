...
@section('content')
    @include('admin.include.project-completed-modals.admin-show-project-completed-modal')
    @include('admin.include.project-completed-modals.admin-delete-project-completed-modal')
