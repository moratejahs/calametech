...
class SuperAdminProjectsNotStartedController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('super-admin.super-admin-projects-not-started', compact(
    ...
    public function edit(Request $request)
    {
        ...
        return redirect()->route('super-admin.super-admin-projects-not-started');
    }
