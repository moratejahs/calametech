<div class="modal fade text-left" id="deleteProjectBehindScheduleModal" tabindex="-1" aria-labelledby="myModalLabel1"
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('delete.super-admin.super-admin-projects-not-started') }}" method="POST">
                @csrf
                @method('DELETE')
