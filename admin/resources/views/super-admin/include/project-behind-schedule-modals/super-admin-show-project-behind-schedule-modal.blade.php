<div class="modal fade text-left" id="viewProjectBehindScheduleModal" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="showProjectValidation" action="{{ route('edit.super-admin.super-admin-projects-in-progress') }}"
                method="POST">
                @csrf
                @method('PUT')
