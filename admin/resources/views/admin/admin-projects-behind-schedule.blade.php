...
@section('content')
    {{-- project modal data --}}
    @include('admin.include.project-behind-schedule-modals.admin-show-project-behind-schedule-modal')
    @include('admin.include.project-behind-schedule-modals.admin-delete-project-behind-schedule-modal')
    <div id="main">
