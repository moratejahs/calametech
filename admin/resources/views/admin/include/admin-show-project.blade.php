<div class="modal fade text-left" id="viewProjectUser" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="showProjectValidation" action="{{ route('edit.admin.admin-project') }}" method="POST">
