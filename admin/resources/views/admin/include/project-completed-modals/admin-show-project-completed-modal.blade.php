<div class="modal fade text-left" id="viewProjectCompletedModal" data-bs-backdrop="static" data-bs-keyboard="false"
    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle">Project Information</h5>
            ...
            <form id="showProjectValidation" action="{{ route('edit.admin.admin-project-completed') }}" method="POST">
                @csrf
                @method('PUT')
                            ...
                            <div class="col-6">
                                <div class="col-12 pb-2">
                                    <span class=" fst-italic" style="font-size: 25px;">
                                        Completed Date: <label id="completedDate"></label>
                                    </span>
                                </div>
                            </div>
                            <div class="col-6">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="taskName" name="taskName" type="text" class="form-control"
                                                placeholder="Enter task name" aria-describedby="taskNameIcon" disabled>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="ownerName" name="projectOwner" type="text"
                                                ...
                                                aria-describedby="ownerNameIcon" disabled>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="dueDate" name="dueDate" type="date" class="form-control"
                                                aria-describedby="dueDateIcon" disabled>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="remark" name="userRemark" type="text" class="form-control"
                                                placeholder="Enter Remark" aria-describedby="remarkIcon" disabled>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="budget" name="userBudget" type="text" class="form-control"
                                                placeholder="Enter Budget" aria-describedby="budgetIcon" disabled>
                                        </div>
                                    </div>
