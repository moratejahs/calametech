...
@section('content')
    {{-- project modal data --}}
    @include('super-admin.include.project-not-started-modals.super-admin-show-project-not-started-modal')
    @include('super-admin.include.project-not-started-modals.super-admin-delete-project-not-started-modal')
    <div id="main">
            ...
            <section class="section">
                <div class="card">
                    <div class="card-header">
                        <h5>Not Started Project Records</h5>
                    </div>
                    <div class="card-body">
                        <table class="table table-hover" id="userProjectTable">
                            ...
                            <tbody>
                                ...
                                @foreach ($notStartedProjectData as $project)
                                    <tr>
                                        <td>
                                            {{ $loop->iteration }}
                                        </td>
                                        ...
                                        @endphp
                                        <td class="hover-timeLine" data-timeline="{{ $dueDate->diffInDays($currentDate) }}"
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                ...
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#viewProjectNotStartedModal"
                                                    ...
                                                    data-bs-timeLine         = "{{ $dueDate->diffInDays($currentDate) }}">
                                                ...
                                                @if ($project->created_by == auth()->user()->id)
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                        data-bs-target     ="#deleteProjectNotStartedModal"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const viewRecordUser = document.querySelectorAll(
                'button[data-bs-target="#viewProjectNotStartedModal"]');
            const removeRecord = document.querySelectorAll(
                'button[data-bs-target="#deleteProjectNotStartedModal"]');
            ...
            viewRecordUser.forEach(function(button) {
                button.addEventListener('click', function() {
                    ...
                    if (timeLine == 0) {
                        document.getElementById('timeLine').textContent = 'Today';
                    } else {
                        document.getElementById('timeLine').textContent = timeLine + ' days left';
                    }
